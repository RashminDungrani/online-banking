...
$Account_no = $row_customer['account_no'];
$Username = $row_customer['username'];
$Fullname = $row_customer['full_name'];
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <!-- Comment -->
                        <!-- ============================================================== -->
                      <li class="nav-item d-none d-md-block h1"><a class="nav-link sidebartoggler waves-effect waves-light font-24" href="javascript:void(0)" data-sidebartype="mini-sidebar">
                        <i class="mdi mdi-account font-24"></i>
                        <?php echo $txt_fullname; ?>
                      </a>
                    </li>
                            ...
                            <form class="form-horizontal">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Account Number</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="txt_account_no" value="<?php echo $Account_no?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Username</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="txt_username" value="<?php echo $Username?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Full Name</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="txt_fullname" value="<?php echo $Fullname?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Mobile</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="txt_mobile" value="<?php echo $Mobile?>" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label">Email</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="txt_email" value="<?php echo $Email ?> ">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Address</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="txt_address" value="<?php echo $Address?>" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Pin Code</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="txt_pincode" value="<?php echo $Pincode?>" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="txt_ifsc">
                                        </div>
                                    </div>
                                </div>
